...
#> # A tibble: 6 x 9
#>   input_name               Spelling           Suggested_name       Distance taxonomicStatus nomenclaturalStatus acceptedName   family        matches
#>   <chr>                    <chr>              <chr>                   <dbl> <chr>           <chr>               <chr>          <chr>         <chr>  
#> 1 "Zonotrichia capensis"   Correct            Zonotrichia capensis        0 nome_aceito     NA                  NA             Passerellidae single 
#> 2 "Mazama bororo"          Correct            Mazama bororo               0 sinonimo        NA                  Mazama jucunda Cervidae      single 
#> 3 "Mazama jucunda"         Correct            Mazama jucunda              0 nome_aceito     NA                  NA             Cervidae      single 
#> 4 "Arrenurus tumulosus"    Correct            Arrenurus tumulosus         0 nome_aceito     NA                  NA             Arrenuridae   single 
#> 5 "Pantera onca"           Probably_incorrect Panthera onca               2 nome_aceito     NA                  NA             Felidae       single 
...
No caso de *Pantera onca*, a ortografia parece estar potencialmente incorreta (já que o nome não foi encontrado no banco de dados); no entanto, um nome semelhante, *Panthera onca*, é sugerido pela função. A coluna 'Distance' indica a distância de edição de Levenshtein entre a entrada e o nome sugerido.
...
#> 49343     Panthera onca                  <NA>    nome_aceito
