...
plot(spp_spt$`Panthera onca`$states_countries,
     main = paste0(names(spp_spt)[[1]], " - States and Countries"), mar = NA)
...
plot(spp_spt$`Mazama jucunda`$states_countries,
     main = paste0(names(spp_spt)[[2]], " - States and Countries"), mar = NA)
```
...
pol_spp <- fauna_spat_occ(data = bf, species = my_spp,
                       state = TRUE, country = TRUE, state_and_country = TRUE,
                       verbose = TRUE)
